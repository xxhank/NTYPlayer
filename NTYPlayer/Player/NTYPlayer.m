...
@property (nonatomic, strong) NSMutableArray<NTYObserverType> *disposeArray;
@property (nonatomic, strong) NTYPlayerView                   *view;
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _disposeArray = [NSMutableArray array];
        _view         = [[NTYPlayerView alloc] initWithFrame:CGRectZero];
...
- (void)_clearObservers {
    ...
    for (NTYNotificationObserver *d in self.disposeArray) {
        [d dispose];
    }
}
